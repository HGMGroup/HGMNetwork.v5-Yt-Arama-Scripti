registerPlugin({
    name: '[HGMNetwork] Arama Scripti',
    version: 'Script Versiyon v5',
    engine: '>= 1.0.0',
    backends: ["ts3", "discord"],
    description: 'Youtube video arama',
    author: 'HGMNetwork',
	requiredModules: ["http"],
    vars: [
        {
            name: 'yt_apikey',
            title: 'YOUTUBE API KEY (https://console.developers.google.com/project)',
            type: 'string'
        },
        {
            name: 'ytdl_action',
            title: 'Aratilan Video Ne Olsun ?',
            type: 'select',
            indent: 1,
            options: [
                'Hicbirsey',
        ...
        {
            name: 'yt_catchurl',
            title: 'Youtube Linklerini Tutsun?',
            type: 'checkbox'
        },
        {
            name: 'yt_maxresults',
            title: 'Max Sonuc Sayisi (1~>=50)',
            type: 'number',
            placeholder: '1'
        },
        {
            name: 'yt_maxduration',
            title: 'Maximum Video Suresi 900 Saniye = 15 dakika.',
            type: 'number',
            placeholder: '900'
        },
        {
            name: 'yt_randomplay',
            title: 'Max Sonuc (2) Veya Daha Az Oldugunda Rastgele Video Acsin?',
            type: 'checkbox'
        },
        {
        ...
        },
        {
            ...
            title: 'Banlanan Videolar <virgul koyularak.>',
            type: 'string',
            placeholder: '10 saat, ...'
        },
        {
            name: 'command_adminpermissions',
            title: 'Admin Kullanicilar (UID Veya Nick)',
            type: 'array',
            vars: [
                {
                    name: 'user',
                    type: 'string',
                    indent: 2,
                    placeholder: 'Nick Veya UID'
                }
            ]
        },
        {
            name: 'command_blacklistusers',
            title: 'Yasakli Kullanicilar <Virgul Koyularak.> ',
            type: 'string',
            placeholder: 'Nick, Veya UID'
        },
        {
            name: 'command_permissionsServerGroups',
            title: 'Belirli Sunucu Yetkisine Sahip Olanlarda Arama Yapabilsin?',
            type: 'array',
            vars: [
                {
                    name: 'group',
    ...
    var youtube = {
        ...
        commands: {
            'youtube': {
                syntax: '[B][COLOR=#ff0000]HGM[/COLOR]Network - [COLOR=#ff0000]Kullanim[/COLOR]: !{cmd} - <Aratilacak Kelime>',
                active: true,
                hidden: true,
                admin: false,
